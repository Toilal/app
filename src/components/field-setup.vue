      ...
      var collectionData = {
        ...
        fields: [
          ...
          },
          {
            ...
            length: this.columnDefaultLength(this.primaryKeyFieldByCollection(this.relationInfoM2M[0].collection_one).type),
          ...
          },
          {
            ...
            type: this.columnDefaultDatatype(this.primaryKeyFieldByCollection(this.relationInfoM2M[1].collection_one).type),
            length: this.columnDefaultLength(this.primaryKeyFieldByCollection(this.relationInfoM2M[1].collection_one).type),
